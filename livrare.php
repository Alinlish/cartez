...
?>
  ...
  <div id="container">
    ...
    <h1 align="center">Livrare</h1><br /><br />
	<p>Pentru comenzile plasate de luni pînă joi între orele 9-18 livrarea se face a doua zi pentru cărtile aflate în stocul propriu.</p>
    <p>Comenzile plasate de vineri pînă duminică se procesează în ziua de luni următoare.</p>
    <p>Unele cărţi s-ar putea sa nu mai fie disponibile în stocul editurilor sau ale distribuitorilor. În acest caz un reprezentant Cartez vă va contacta pentru a stabili detaliile comenzii.</p>
    <p>Semnificaţii stoc:</p>
    <p>-	ÎN STOC - cartea se află în stocul nostru şi va fi expediată în maxim 24 ore de la primirea comenzii</p>
    <p>-	LA COMANDĂ - cartea este disponibilă în stocul editurii şi poate fi livrată între 1-7 zile lucrătoare</p>
    <p>-	STOC EPUIZAT - cartea nu mai este disponibilă nici la editură nici în stocul propriu. Poate deveni disponibilă numai în cazul unei re-editări sau suplimentări a tirajului.</p>
